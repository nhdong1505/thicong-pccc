...
<div class="wp-block-group banner-nav-inner-box has-primary-background-color has-background" style="padding-top:33%;padding-right:var(--wp--preset--spacing--80);padding-bottom:15px;padding-left:40px"><!-- wp:buttons {"className":"banner-navigate-btn"} -->
